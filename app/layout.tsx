...
export default function RootLayout({
  ...
  return (
    <html lang="zh-CN" className="scroll-smooth">
      ...
      <body className="antialiased bg-space-950 text-space-100 font-sans min-h-screen">
        <div className="flex flex-col min-h-screen">
          {/* 科技感导航栏 */}
          <header className="sticky top-0 z-50 bg-space-900/95 backdrop-blur-2xl border-b border-space-800/60 shadow-tech">
            <div className="container-custom">
              <div className="flex justify-between items-center h-28">
                <a 
                  href="/" 
                  className="text-4xl font-black text-gradient-hero hover:scale-105 transition-all duration-300 tracking-tighter"
                >
                  The Code Craft
                </a>
          ...
          {/* 科技感页脚 */}
          <footer className="bg-space-900/90 backdrop-blur-2xl border-t border-space-800/60 py-24">
            <div className="container-custom">
              <div className="text-center">
                ...
                <p className="text-space-400 text-xl leading-relaxed max-w-3xl mx-auto mb-16 font-normal">
                ...
                <div className="border-t border-space-800/60 pt-16">
                  <p className="text-space-500 text-sm font-medium">
                    © <Copyright /> The Code Craft. 基于 Next.js 构建
                  </p>
                  <div className="mt-4 flex justify-center space-x-8">
                    <a href="/about" className="text-space-500 hover:text-space-300 dark:hover:text-space-300 text-sm font-medium transition-colors">关于</a>
                    <a href="/privacy" className="text-space-500 hover:text-space-300 dark:hover:text-space-300 text-sm font-medium transition-colors">隐私政策</a>
                    <a href="/contact" className="text-space-500 hover:text-space-300 dark:hover:text-space-300 text-sm font-medium transition-colors">联系我们</a>
                  </div>
                </div>
              </div>
            </div>
